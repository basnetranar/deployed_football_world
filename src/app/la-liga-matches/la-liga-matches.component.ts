...
@Component({
  selector: 'app-la-liga-matches',
  templateUrl: './la-liga-matches.component.html',
  styleUrls: ['./la-liga-matches.component.css']
})
export class LaLigaMatchesComponent implements OnInit {

baseUrl:string = 'https://api.football-data.org/v2/competitions/2014/matches';
