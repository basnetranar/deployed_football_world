...
@Component({
  selector: 'app-italian-seria-table',
  templateUrl: './italian-seria-table.component.html',
  styleUrls: ['./italian-seria-table.component.css']
})
export class ItalianSeriaTableComponent implements OnInit {
  
    baseUrl:string = 'https://api.football-data.org/v2/competitions/2019/standings';
