...
@Component({
  selector: 'app-bundesliga-teams',
  templateUrl: './bundesliga-teams.component.html',
  styleUrls: ['./bundesliga-teams.component.css']
})
export class BundesligaTeamsComponent implements OnInit {

baseUrl:string = 'http://api.football-data.org/v2/competitions/2002/teams';
auth:string = "X-Auth-Token";
 ...
 teamName:string = "FC Bayern München";
 teamAddress:string = "Säbenerstr. 51 München 81547";
 teamEmail: string = "service-team@fcb.de";
 teamFounded: number = 1900;
 teamWebsite: string = "http://www.fcbayern.de";
