...
@Component({
  selector: 'app-la-liga-teams',
  templateUrl: './la-liga-teams.component.html',
  styleUrls: ['./la-liga-teams.component.css']
})
export class LaLigaTeamsComponent implements OnInit {

 baseUrl:string = 'https://api.football-data.org/v2/competitions/2014/teams';
 ...
 teamName:string = "Real Madrid CF";
 teamAddress:string = "Avenida Concha Espina, 1 Madrid 28036";
 teamEmail: string = "atencionpublico@corp.realmadrid.com";
 teamFounded: number = 1902;
 teamWebsite: string = "http://www.realmadrid.com";
