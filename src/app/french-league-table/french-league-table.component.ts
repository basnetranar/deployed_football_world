...
@Component({
  selector: 'app-french-league-table',
  templateUrl: './french-league-table.component.html',
  styleUrls: ['./french-league-table.component.css']
})
export class FrenchLeagueTableComponent implements OnInit {

 baseUrl:string = 'https://api.football-data.org/v2/competitions/2015/standings';
