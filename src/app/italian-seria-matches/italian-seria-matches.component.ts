...
@Component({
  selector: 'app-italian-seria-matches',
  templateUrl: './italian-seria-matches.component.html',
  styleUrls: ['./italian-seria-matches.component.css']
})
export class ItalianSeriaMatchesComponent implements OnInit {

baseUrl:string = 'https://api.football-data.org/v2/competitions/2019/matches';
