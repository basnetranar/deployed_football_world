...
@Component({
  selector: 'app-french-league-teams',
  templateUrl: './french-league-teams.component.html',
  styleUrls: ['./french-league-teams.component.css']
})
export class FrenchLeagueTeamsComponent implements OnInit {

 baseUrl:string = 'https://api.football-data.org/v2/competitions/2015/teams';
 ...
 teamName:string = "Paris Saint-Germain FC";
 teamAddress:string = "24, rue de Commandant Guibaud Paris ";
 teamEmail: string = "communaute@psg.fr";
 teamFounded: number = 1904;
 teamWebsite: string = "http://www.psg.fr";
 ...
 constructor(private http:HttpClient) { }
  ...
  teamInfo(indexValue){
    ...
    this.http.get('https://api.football-data.org/v2/teams/'+this.teamID+'/matches',{headers: new HttpHeaders().set(this.auth,this.key)}) 
      .subscribe(res => {
