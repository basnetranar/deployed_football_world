...
@Component({
  selector: 'app-bundesliga-matches',
  templateUrl: './bundesliga-matches.component.html',
  styleUrls: ['./bundesliga-matches.component.css']
})
export class BundesligaMatchesComponent implements OnInit {

baseUrl:string = 'https://api.football-data.org/v2/competitions/2002/matches';
